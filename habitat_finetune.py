...
from dataloader import HabitatLoader as DA
...
parser.add_argument('--train_split', default='',
                    help='train_split path')
parser.add_argument('--test_split', default='',
                    help='test_split path')
...
TrainImgLoader = torch.utils.data.DataLoader(
         DA.myImageFloder(args.train_split, True), 
         batch_size= 8, shuffle= True, num_workers= 8, drop_last=False)

TestImgLoader = torch.utils.data.DataLoader(
         DA.myImageFloder(args.test_split, False), 
