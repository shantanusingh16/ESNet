...
def main(opt):
    ...
    #whethe calculate multiscaleloss only on.....
    ...
    for r in range(opt.startRound, train_round):
        criterion = multiscaleloss(loss_scale, 1, loss_weights[r], train_loss = 'smoothL1', test_loss='L1', mask = mask)
...
if __name__ == '__main__':
    ...
    #parser.add_argument('--trainloss', type=str, help='indicates the train loss scheme, only used for pwcnet', default = 'L1_pwc', choices=['L1_pwc','smoothL1_pwc','robust_EPE'])
    ...
    parser.add_argument('--datapath', type=str, help='provide the root path of the data', default='mynfs/scene_flow/')
